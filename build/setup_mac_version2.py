...
usage = """Usage: sudo python setup_mac_version2.py py2app --iconfile=landeBMWIcon.icns --version=X.X.X"""
...
setup(
    ...
    version = version,
    data_files = [('.',['../source/version2/colormaps.txt']),
                  ('.',['../source/version2/tips_and_tricks.html']),
                  ('.',['../source/version2/ChangeLog.txt']),
                  ('xbms',allXBMS),
                  ('StandardQ',allStandardQ)
                 ],
    app=["../source/version2/AreaDiffractionMachine.py"],
