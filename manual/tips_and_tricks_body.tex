...
tasks are recorded, the \gui{Stop Record Macro} option will
stop recording the macro and save it to a file. The
\gui{Run Saved Macro} option can be used to run a macro from
a file. 
...
a filename. Instead of a filename, the \macroline{Data File:} macro
...
files will end with a subsequent \macroline{Data File:} command,
...
\macroline{PATHNAME/FILENAME\_int.dat}. It would save the intensity
