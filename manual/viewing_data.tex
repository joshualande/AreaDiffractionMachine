...
the program. To do so, you can see the \gui{Data File:} input.
...
the \gui{File} menu bar and select the \gui{Save Image} option.

The formats currently allowed are \gui{jpg}, \gui{gif}, \gui{eps}, 
\gui{pdf}, \gui{bmp}, \gui{png}, \gui{tiff}, and the ESRF data 
format \gui{edf}.
