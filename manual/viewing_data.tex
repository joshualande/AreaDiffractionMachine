...
the \gui{Calibration} tab. This is shown in 
figure~\ref{calibration_tab}. The \gui{Data File:} input can be 
...
The diffraction data window can be used to interact with the
