...
The higher the value of \gui{Stddev} is, the
...
\gui{Calibration} tab. This tab is shown 
...
Once these have been loaded, the \gui{Do Fit}
...
The \gui{Draw Peaks?} can be used to 
